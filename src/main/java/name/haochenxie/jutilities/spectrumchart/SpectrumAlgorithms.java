 ...
 */
public class SpectrumAlgorithms {
    ...
    /**
     * An algorithm to approximately convert wavelength to RGB. The approximation is very rough though.
     * <p>
     * Original algorithm implemented in FORTRAN by Dan Bruton (astro@tamu.edu)
     * <p>
     * Taken from Dan Bruton's page: http://www.midnightkite.com/color.html
     * <p>
     * Taken from Earl F. Glynn's web page: http://www.efg2.com/Lab/ScienceAndEngineering/Spectra.htm
     * <p>
     * Java Implementation taken from StackOverflow: http://stackoverflow.com/questions/1472514/convert-light-frequency-to-rgb
     *
     * @param Wavelength wavelength in nm
     * @return RGB color whose values of the 3 primaries in an array. [0] holds the red value, [1] holds the green
     * value, and [2] holds the blue value. each value is in the range [0, 255]
     */
    public static int[] brutonWavelengthToRGBAppr(double Wavelength){
        double factor;
